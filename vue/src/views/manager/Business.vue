...
<!--        <el-table-column prop="password" label="密码"></el-table-column>-->
        ...
        <el-table-column label="营业执照">
          <template v-slot="scope">
            <div style="display: flex; align-items: center">
              <el-image style="width: 40px; height: 40px; border-radius: 50%" v-if="scope.row.license"
        ...
        <el-table-column label="操作" align="center" width="180" fixed="right">
          <template v-slot="scope">
            <el-button size="mini" type="primary" plain @click="handleEdit(scope.row)">编辑/审核</el-button>
    ...
    <el-dialog title="商家表" :visible.sync="fromVisible" width="40%" :close-on-click-modal="false" destroy-on-close>
