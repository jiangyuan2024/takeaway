<template>
	<view>
		<view class="search">
			<uni-search-bar ref="searchRef" class="searchInput" @confirm="search" :focus="false" placeholder="搜索商家" v-model="searchValue.value"></uni-search-bar>
			<button @click="search(searchValue)" class="searchButton">搜索</button>
		</view>
